...
# Specify 2x2 plot arrangement filled columnwise
par(mfcol=c(2,2))

# Upper left plot
plot(epcg$DateTime, epcg$Global_active_power,type='l', ylab='Global Active Power',xlab='')
...
legend('topright',legend=c('Sub_metering_1','Sub_metering_2','Sub_metering_3'), lty=rep(1,3), col=c('black','red','blue'), bty='n')

# Upper right plot
plot(epcg$DateTime, epcg$Voltage,type='l', ylab='Voltage', xlab='datetime')

# Lower right plot
plot(epcg$DateTime, epcg$Global_reactive_power, type='l', ylab='Global_reactive_power', xlab='datetime')
